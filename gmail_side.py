...
# MAIL STUFF 
import smtplib, ssl # Simple Mail Transfer Protocol (SMTP)
        ...
        if db_event.email_notified == 'False' :
            ...
            if (event_date_year == int(ct.year)) and (event_date_month == int(ct.month)) and (event_date_day == int(ct.day)):
                ...
                if (int(event_time_24 - current_time_24)) < 10 and (int(event_time_24 - current_time_24)) > 0:
                    ...
                    - Syllendar Team""".format(db_event.event_title)
                    ...
                    notified_event = models.Events(db_event.name, db_event.email, db_event.event_title, db_event.event_start_date, db_event.event_start_time, db_event.event_end_date, db_event.event_end_time, db_event.imp_flag, 'True', db_event.location, db_event.contact_number, db_event.descirption, db_event.day, db_event.year, db_event.month)
                    # Delete 
